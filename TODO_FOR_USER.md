...
### ⚪ Decide a licence
- [ ] `README.md` says "not yet decided". The repo is public, so with no licence
      nobody may legally reuse it — including you, from another machine, under
      any assumption of permission.
